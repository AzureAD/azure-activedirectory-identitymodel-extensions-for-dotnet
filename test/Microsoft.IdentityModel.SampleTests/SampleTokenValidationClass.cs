...
namespace Microsoft.IdentityModel.SampleTests
{
    ...
    class SampleTokenValidationClass
    {
        ...
        public async Task<TokenValidationResult> ValidateTokenShimWithNewPath(string token)
        {
        ...
        {
            ValidateTokenShimWithDeprecatedModel(token, TokenValidationParameters);
        }
        ...
        public async Task<TokenValidationResult> ValidateTokenShimWithNewPath(string token, ValidationParameters validationParameters)
        {
            CallContext callContext = new CallContext();
            TokenValidationResult result = await JsonWebTokenHandler.ValidateTokenAsync(token, validationParameters, callContext, null);
