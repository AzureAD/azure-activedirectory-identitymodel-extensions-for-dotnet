                ...
                return new TheoryData<ValidateLifetimeTheoryData>
                {
                    ...
                    new ValidateLifetimeTheoryData("ExpiresIsNull")
                    {
                        ...
                        OperationResult = new LifetimeValidationError(
                            ...
                            ValidationFailureType.LifetimeNoExpirationTime,
                            null,
                            oneHourAgo,
                            null),
                    },
                    new ValidateLifetimeTheoryData("NotBeforeIsAfterExpires")
                    {
                        ...
                        OperationResult = new LifetimeValidationError(
                            ...
                            ValidationFailureType.LifetimeNotbeforeGreaterThanExpirationTime,
                            null,
                            oneHourFromNow,
                            oneHourAgo),
                    },
                    new ValidateLifetimeTheoryData("NotYetValid")
                    {
                        ...
                        OperationResult = new LifetimeValidationError(
                            ...
                            ValidationFailureType.LifetimeNotYetValid,
                            null,
                            oneHourFromNow,
                            twoHoursFromNow),
                    },
                    new ValidateLifetimeTheoryData("Expired")
                    {
                        ...
                        OperationResult = new LifetimeValidationError(
                            new MessageDetail(
                                ...
                                LogHelper.MarkAsNonPII(oneHourAgo),
                                LogHelper.MarkAsNonPII(utcNow)),
                            ValidationFailureType.LifetimeExpired,
                            null,
                            twoHoursAgo,
                            oneHourAgo),
                    },
