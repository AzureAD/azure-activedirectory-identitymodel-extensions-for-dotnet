...
namespace Microsoft.IdentityModel.TestUtils
{
    public class IdentityComparerTests
    {
        ...
        public void CompareX509Certificate2()
        {
            ...
            var certificate = CertificateHelper.Load(Convert.FromBase64String(KeyingMaterial.DefaultX509Data_2048_Public));
            var certificateSame = CertificateHelper.Load(Convert.FromBase64String(KeyingMaterial.DefaultX509Data_2048_Public));
