...
namespace Microsoft.IdentityModel.TestUtils
{
    public class ValidationUtils
    {
        ...
        public static ValidationParameters CreateValidationParameters(
            ...
            List<SecurityKey>? signatureKeys = null,
            TimeSpan? clockSkew = null,
            TimeProvider? timeProvider = null,
            TokenReplayCache? tokenReplayCache = null)
        {
            ...
            if (signatureKeys != null)
                signatureKeys.ForEach(validationParameters.SignatureKeys.Add);
            else
                validationParameters.SignatureKeys.Add(Default.AsymmetricSigningCredentials.Key);
