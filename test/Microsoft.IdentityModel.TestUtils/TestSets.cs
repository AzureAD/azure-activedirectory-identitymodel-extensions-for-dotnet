...
namespace Microsoft.IdentityModel.TestUtils
{
    ...
    public class KeyInfoTestSet : XmlTestSet
    {
        ...
        public static KeyInfoTestSet MultipleCertificates
        {
            get
            {
                var data = new X509Data(new List<X509Certificate2> {
#if NET9_0_OR_GREATER
                    X509CertificateLoader.LoadCertificate(Convert.FromBase64String(Default.CertificateData)),
#else
                    new X509Certificate2(Convert.FromBase64String(Default.CertificateData)),
#endif
#if NET9_0_OR_GREATER
                    X509CertificateLoader.LoadCertificate(Convert.FromBase64String(Default.CertificateData))
#else
