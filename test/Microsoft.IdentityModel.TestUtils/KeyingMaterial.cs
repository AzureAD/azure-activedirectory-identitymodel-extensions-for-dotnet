    ...
    static public class KeyingMaterial
    {
        ...
        public static X509Certificate2 AADSigningCert
        {
            get =>
                ...
                X509CertificateLoader.LoadCertificate(Convert.FromBase64String(AADCertData));
#else
                new X509Certificate2(Convert.FromBase64String(AADCertData));
#endif
        }
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned1024_SHA256), SelfSigned1024_SHA256_PasswordString, X509KeyStorageFlags.PersistKeySet);
#else
            new X509Certificate2(Convert.FromBase64String(SelfSigned1024_SHA256), SelfSigned1024_SHA256_Password, X509KeyStorageFlags.PersistKeySet);
#endif
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned1024_SHA256_Public), SelfSigned1024_SHA256_PasswordString);
#else
            new X509Certificate2(Convert.FromBase64String(SelfSigned1024_SHA256_Public), SelfSigned1024_SHA256_Password);
#endif
        ...
        public static X509Certificate2 CertSelfSigned2048_SHA256 =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA256), SelfSigned2048_SHA256_PasswordString, X509KeyStorageFlags.PersistKeySet);
#else
            new X509Certificate2(Convert.FromBase64String(SelfSigned2048_SHA256), SelfSigned2048_SHA256_Password, X509KeyStorageFlags.PersistKeySet);
#endif
        public static X509SecurityKey X509SecurityKeySelfSigned2048_SHA256 = new X509SecurityKey(CertSelfSigned2048_SHA256);
        public static X509Certificate2 CertSelfSigned2048_SHA256_Public =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA256_Public), SelfSigned2048_SHA256_PasswordString);
#else
        new X509Certificate2(Convert.FromBase64String(SelfSigned2048_SHA256_Public), SelfSigned2048_SHA256_Password);
#endif
        ...
        public static X509Certificate2 CertSelfSigned2048_SHA256_2 =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA256_2), SelfSigned2048_SHA256_2_PasswordString, X509KeyStorageFlags.PersistKeySet);
#else
            new X509Certificate2(Convert.FromBase64String(SelfSigned2048_SHA256_2), SelfSigned2048_SHA256_2_Password, X509KeyStorageFlags.PersistKeySet);
#endif
        ...
        public static X509Certificate2 CertSelfSigned2048_SHA384 =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA384), SelfSigned2048_SHA384_PasswordString, X509KeyStorageFlags.PersistKeySet);
#else
            new X509Certificate2(Convert.FromBase64String(SelfSigned2048_SHA384), SelfSigned2048_SHA384_Password, X509KeyStorageFlags.PersistKeySet);
#endif
        public static X509SecurityKey X509SecurityKeySelfSigned2048_SHA384 = new X509SecurityKey(CertSelfSigned2048_SHA384);
        public static X509Certificate2 CertSelfSigned2048_SHA384_Public =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA384_Public), SelfSigned2048_SHA384_PasswordString);
#else
        new X509Certificate2(Convert.FromBase64String(SelfSigned2048_SHA384_Public), SelfSigned2048_SHA384_Password);
#endif
        ...
        public static X509Certificate2 CertSelfSigned2048_SHA512 =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA512), SelfSigned2048_SHA512_PasswordString, X509KeyStorageFlags.PersistKeySet);
#else
            new X509Certificate2(Convert.FromBase64String(SelfSigned2048_SHA512), SelfSigned2048_SHA512_Password, X509KeyStorageFlags.PersistKeySet);
#endif
        public static X509SecurityKey X509SecurityKeySelfSigned2048_SHA512 = new X509SecurityKey(CertSelfSigned2048_SHA512);
        public static X509Certificate2 CertSelfSigned2048_SHA512_Public =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA512_Public), SelfSigned2048_SHA512_PasswordString);
#else
            new X509Certificate2(Convert.FromBase64String(SelfSigned2048_SHA512_Public), SelfSigned2048_SHA512_Password);
#endif
        ...
        public static X509Certificate2 Cert_AAD_Public =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadCertificate(Convert.FromBase64String(X509Data_AAD_Public));
#else
            new X509Certificate2(Convert.FromBase64String(X509Data_AAD_Public));
#endif
        ...
        public static X509Certificate2 Cert_LocalSts =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(X509Data_LocalSts), CertPasswordString, X509KeyStorageFlags.MachineKeySet);
#else
            new X509Certificate2(Convert.FromBase64String(X509Data_LocalSts), CertPassword, X509KeyStorageFlags.MachineKeySet);
#endif
        ...
        public static X509Certificate2 Cert_1024 =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(X509Data_1024), CertPasswordString, X509KeyStorageFlags.MachineKeySet);
#else
            new X509Certificate2(Convert.FromBase64String(X509Data_1024), CertPassword, X509KeyStorageFlags.MachineKeySet);
#endif
        ...
        public static X509Certificate2 DefaultCert_2048 =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(DefaultX509Data_2048), CertPasswordString, X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.Exportable);
#else
            new X509Certificate2(Convert.FromBase64String(DefaultX509Data_2048), CertPassword, X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.Exportable);
#endif
        ...
        public static X509Certificate2 DefaultAsymmetricCert_2048 =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(DefaultX509Data_2048), CertPasswordString, X509KeyStorageFlags.MachineKeySet);
#else
        new X509Certificate2(Convert.FromBase64String(DefaultX509Data_2048), CertPassword, X509KeyStorageFlags.MachineKeySet);
#endif
        ...
        public static X509Certificate2 DefaultCert_2048_Public
        {
            get =>
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadCertificate(Convert.FromBase64String(DefaultX509Data_2048_Public));
#else
            new X509Certificate2(Convert.FromBase64String(DefaultX509Data_2048_Public));
#endif
        }
        ...
        public static X509Certificate2 ExpiredX509Cert_Public =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadCertificate(Convert.FromBase64String(ExpiredX509Data_Public));
#else
        new X509Certificate2(Convert.FromBase64String(ExpiredX509Data_Public));
#endif
        ...
        public static X509Certificate2 NotYetValidX509Cert_Public =
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadCertificate(Convert.FromBase64String(NotYetValidX509Data_Public));
#else
            new X509Certificate2(Convert.FromBase64String(NotYetValidX509Data_Public));
#endif
        ...
        public static SecurityKey DefaultAADSigningKey
        {
            get
            {
                ...
                var aadCert =
#if NET9_0_OR_GREATER
                    X509CertificateLoader.LoadCertificate(Convert.FromBase64String(certData));
#else
        ...
        static KeyingMaterial()
        {
            X509Certificate1 =
#if NET9_0_OR_GREATER
                X509CertificateLoader.LoadCertificate(Convert.FromBase64String(""));
#else
                new X509Certificate2(Convert.FromBase64String(""));
#endif
            X509Certificate2 =
#if NET9_0_OR_GREATER
                X509CertificateLoader.LoadCertificate(Convert.FromBase64String(""));
#else
                new X509Certificate2(Convert.FromBase64String(""));
#endif
