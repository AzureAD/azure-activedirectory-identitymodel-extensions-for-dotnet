...
namespace Microsoft.IdentityModel.TestUtils
{
    static public class KeyingMaterial
    {
        ...
        {
            get => CertificateHelper.Load(Convert.FromBase64String(AADCertData));
        }
...
#pragma warning disable SYSLIB0057 // X509CertificateLoader does not have the correct overloads for this constructor
        ...
        public static X509Certificate2 Cert_AAD_Public = CertificateHelper.Load(Convert.FromBase64String(X509Data_AAD_Public));
...
#pragma warning restore SYSLIB0057
        ...
        {
            get => CertificateHelper.Load(Convert.FromBase64String(DefaultX509Data_2048_Public));
        }
        ...
        public static X509Certificate2 ExpiredX509Cert_Public = CertificateHelper.Load(Convert.FromBase64String(ExpiredX509Data_Public));
        ...
        public static X509Certificate2 NotYetValidX509Cert_Public = CertificateHelper.Load(Convert.FromBase64String(NotYetValidX509Data_Public));
        ...
        public static SecurityKey DefaultAADSigningKey
        {
            get
            {
                ...
                var aadCert = CertificateHelper.Load(Convert.FromBase64String(certData));
        ...
        public static SecurityKey DefaultRsaSecurityKey2
        {
            ...
            {
                var certData = "";
                var cert = CertificateHelper.Load(Convert.FromBase64String(certData));
                AsymmetricAlgorithm publicKey;
#if NET462 || NET472 || NET_CORE
