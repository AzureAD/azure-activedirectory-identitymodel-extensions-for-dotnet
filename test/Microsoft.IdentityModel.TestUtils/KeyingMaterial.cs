...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned1024_SHA256), SelfSigned1024_SHA256_Password, X509KeyStorageFlags.PersistKeySet);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned1024_SHA256_Public), SelfSigned1024_SHA256_Password);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA256), SelfSigned2048_SHA256_Password, X509KeyStorageFlags.PersistKeySet);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA256_Public), SelfSigned2048_SHA256_Password);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA256_2), SelfSigned2048_SHA256_2_Password, X509KeyStorageFlags.PersistKeySet);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA384), SelfSigned2048_SHA384_Password, X509KeyStorageFlags.PersistKeySet);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA384_Public), SelfSigned2048_SHA384_Password);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA512), SelfSigned2048_SHA512_Password, X509KeyStorageFlags.PersistKeySet);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(SelfSigned2048_SHA512_Public), SelfSigned2048_SHA512_Password);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(X509Data_LocalSts), CertPassword, X509KeyStorageFlags.MachineKeySet);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(X509Data_1024), CertPassword, X509KeyStorageFlags.MachineKeySet);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(DefaultX509Data_2048), CertPassword, X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.Exportable);
#else
...
#if NET9_0_OR_GREATER
            X509CertificateLoader.LoadPkcs12(Convert.FromBase64String(DefaultX509Data_2048), CertPassword, X509KeyStorageFlags.MachineKeySet);
#else
