...
namespace Microsoft.IdentityModel.Validators.Tests
{
    public class MicrosoftIdentityIssuerValidatorTest
    {
        ...
        public async Task Validate_NullOrEmptyParameters_ThrowsException()
        {
            ...
            OperationResult<ValidatedIssuer, IssuerValidationError> operationResult = await ValidateIssuerAsync(string.Empty, jwtSecurityToken, validator);
        ...
        public async Task Validate_IssuerMatchedInValidIssuer_ReturnsIssuer(string tidClaimType, string tenantId, string issuer, bool useConfigurationManagerProvider)
        {
            ...
            OperationResult<ValidatedIssuer, IssuerValidationError> operationResult = await ValidateIssuerAsync(issuer, issuer, jwtSecurityToken, validator);

            IdentityComparer.AreEqual(operationResult.Result.Issuer, actualIssuer, context);
        ...
        public async Task Validate_NoHttpclientFactory_ReturnsIssuer(string tidClaimType, string tenantId, string issuer)
        {
            ...
            OperationResult<ValidatedIssuer, IssuerValidationError> operationResult = await ValidateIssuerAsync(issuer, configurationManager, jwtSecurityToken, validator);

            IdentityComparer.AreEqual(issuer, operationResult.Result.Issuer, context);
        ...
        public async Task Validate_IssuerMatchedInValidIssuers_ReturnsIssuer(string tidClaimType, bool useConfigurationProvider)
        {
            ...
            OperationResult<ValidatedIssuer, IssuerValidationError> operationResult = await ValidateIssuerAsync(
            ...
            IdentityComparer.AreEqual(ValidatorConstants.AadIssuer, operationResult.Result.Issuer, context);
        ...
        public async Task Validate_V1IssuerNotInTokenValidationParameters_ReturnsV1Issuer(string tidClaimType, bool useConfigurationProvider)
        {
            ...
            Assert.True(operationResult.Succeeded);
            IdentityComparer.AreEqual(ValidatorConstants.V1Issuer, operationResult.Result.Issuer, context);
        ...
        public async Task Validate_TidClaimInToken_ReturnsIssuer()
        {
            ...
            operationResult = await ValidateIssuerAsync(
                ValidatorConstants.AadIssuer,
                ValidatorConstants.AadIssuer,
                jsonWebToken,
                validator);
        ...
        public async Task Validate_InvalidIssuerToValidate_ThrowsException()
        {
            ...
            Assert.False(operationResult.Succeeded);
            IdentityComparer.AreEqual(expectedErrorMessage, operationResult.Error.MessageDetail.Message, context);
        ...
        public async Task Validate_FromB2CAuthority_WithNoTidClaim_ValidateSuccessfully()
        {
            ...
            Assert.True(operationResult.Succeeded);
            IdentityComparer.AreEqual(ValidatorConstants.B2CIssuer, operationResult.Result.Issuer, context);
        ...
        public async Task Validate_FromB2CAuthority_InvalidIssuer_Fails()
        {
            ...
            IdentityComparer.AreEqual(expectedMessage, operationResult.Error.MessageDetail.Message, context);
        ...
        public async Task Validate_FromCustomB2CAuthority_ValidateSuccessfully()
        {
            ...
            Assert.True(operationResult.Succeeded);
            IdentityComparer.AreEqual(ValidatorConstants.B2CCustomDomainIssuer, operationResult.Result.Issuer, context);
        ...
        public async Task Validate_FromB2CAuthority_WithTfpIssuer_ThrowsException()
        {
            ...
            Assert.False(operationResult.Succeeded);
            IdentityComparer.AreEqual(LogMessages.IDX40002, operationResult.Error.MessageDetail.Message, context);
        ...
        public async Task Validate_WithAuthorityUsingConfigurationProvider(ProtocolVersion authorityVersion, ProtocolVersion tokenVersion)
        {
            ...
            Assert.True(operationResult.Succeeded);
            IdentityComparer.AreEqual(tokenIssuer, operationResult.Result.Issuer, context);
        ...
        public async Task Validate_CanFetchMetadataWithoutConfigurationProvider(ProtocolVersion authorityVersion, ProtocolVersion tokenVersion)
        {
            ...
            OperationResult<ValidatedIssuer, IssuerValidationError> operationResult = await ValidateIssuerAsync(issuer, jwtSecurityToken, validator);
        ...
        public async Task Validate_UsesLKGWithConfigurationProvider()
        {
            ...
            Assert.True(operationResult.Succeeded);
            IdentityComparer.AreEqual(v2TokenIssuer, operationResult.Result.Issuer, context);
            ...
            IdentityComparer.AreEqual(operationResult.Result.Issuer, v1TokenIssuer, context);
            ...
            Assert.True(operationResult.Succeeded);
            IdentityComparer.AreEqual(v1TokenIssuer, operationResult.Result.Issuer, context);
            IdentityComparer.AreEqual(v1TokenIssuer, actualIssuer, context);
            TestUtilities.AssertFailIfErrors(context);
            ...
            IdentityComparer.AreEqual(
                ...
                operationResult.Error.MessageDetail.Message,
                context);
        ...
        private static async Task<OperationResult<ValidatedIssuer, IssuerValidationError>> ValidateIssuerAsync(
