...
namespace Microsoft.IdentityModel.Protocols.SignedHttpRequest.Tests
{
    public class SignedHttpRequestValidationTests
    {
        ...
        {
            // Arrange - request path and signed 'p' claim differ by literal case and percent-triplet hex case; disabling the switch selects the case-insensitive comparison, which is the default on the 8.x line.
        ...
        {
            // Arrange - request path and signed 'p' claim differ by literal case and percent-triplet hex case; enabling the switch opts in to the case-sensitive comparison on the 8.x line.
