...
namespace System.IdentityModel.Test
{
    public class KeyingMaterial
    {
        ...
        public static X509AsymmetricSecurityKey AsymmetricKey_Public_2048 = X509Token_Public_2048.SecurityKeys[0] as X509AsymmetricSecurityKey;
        public static SigningCredentials X509SigningCreds_Public_2048_RsaSha2_Sha2     = new SigningCredentials( AsymmetricKey_Public_2048, SecurityAlgorithms.RsaSha256Signature, SecurityAlgorithms.Sha256Digest );


        public static string SymmetricKeyEncoded_256                    ="Vbxq2mlbGJw8XH+ZoYBnUHmHga8/o/IduvU/Tht70iE=";
        public static byte[] SymmetricKeyBytes_256                      = Convert.FromBase64String( SymmetricKeyEncoded_256 );
        public static SymmetricSecurityKey SymmetricSecurityKey_256              = new InMemorySymmetricSecurityKey( SymmetricKeyBytes_256 );
        public static BinarySecretSecurityToken  BinarySecretToken_256  = new BinarySecretSecurityToken( SymmetricKeyBytes_256 );
        public static SigningCredentials SymmetricSigningCreds_256_Sha2 = new SigningCredentials( SymmetricSecurityKey_256, SecurityAlgorithms.HmacSha256Signature, SecurityAlgorithms.Sha256Digest );
        ...
        public static SigningCredentials SymmetricSigningCreds_256_Rsa256_Sha2      = new SigningCredentials( SymmetricSecurityKey_256, SecurityAlgorithms.RsaSha256Signature, SecurityAlgorithms.Sha256Digest );
        public static SigningCredentials SymmetricSigningCreds_256_Rsa256_Sha1      = new SigningCredentials( SymmetricSecurityKey_256, SecurityAlgorithms.RsaSha256Signature, SecurityAlgorithms.Sha1Digest );
