...
namespace Microsoft.IdentityModel.Protocols
{
    ...
    public class WsFederationMessage : AuthenticationProtocolMessage
    {
        ...
        {
            IdentityModelEventSource.Logger.WriteVerbose("WsFederationMessage.FromQueryString: building wsfederation message from query string.");
        ...
        {
            IdentityModelEventSource.Logger.WriteVerbose("WsFederationMessage.FromUri: building wsfederation message from uri.");
        ...
        public WsFederationMessage(WsFederationMessage wsFederationMessage)
        {
            ...
            {
                IdentityModelEventSource.Logger.WriteWarning("WsFederationMessage.Constructor: wsfederation message is null");
                return;
            }
        ...
        public WsFederationMessage(IEnumerable<KeyValuePair<string, string[]>> parameters)
        {
            if (parameters == null)
            {
                IdentityModelEventSource.Logger.WriteWarning("WsFederationMessage.Constructor: parameters dictionary is null");
                return;
            }
        ...
        public virtual string GetToken()
        {
            if (Wresult == null)
            {
                IdentityModelEventSource.Logger.WriteWarning("WsFederationMessage.GetToken: wresult is null");
                return null;
            }
