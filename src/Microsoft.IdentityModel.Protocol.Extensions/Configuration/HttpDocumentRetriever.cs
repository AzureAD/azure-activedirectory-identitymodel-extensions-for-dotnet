...
namespace Microsoft.IdentityModel.Protocols
{
    internal class HttpDocumentRetriever : IDocumentRetriever
    {
        ...
        public HttpDocumentRetriever(HttpClient httpClient)
        {
            if (httpClient == null)
            {
                LogHelper.LogError(string.Format(CultureInfo.InvariantCulture, ErrorMessages.IDX10000, GetType() + ": httpClient"), typeof(ArgumentNullException), EventLevel.Verbose);
            }
