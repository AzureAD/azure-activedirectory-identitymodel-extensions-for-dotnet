...
namespace Microsoft.IdentityModel.Validators
{
    ...
    public partial class AadIssuerValidator
    {
        ...
        internal ValidationResult<ValidatedIssuer, IssuerValidationError> ValidateIssuerSync(
            string issuer,
...
#pragma warning restore CA1031 // Do not catch general exception types
            ...
            try
            {
                ...
                {
                    var baseConfiguration = GetBaseConfigurationSync(effectiveConfigurationManager, validationParameters);
...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        private static BaseConfiguration GetBaseConfigurationSync(BaseConfigurationManager configurationManager, ValidationParameters validationParameters)
        {
