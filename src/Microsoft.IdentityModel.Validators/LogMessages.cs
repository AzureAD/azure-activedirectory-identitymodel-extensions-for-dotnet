...
namespace Microsoft.IdentityModel.Validators
{
    ...
    internal static class LogMessages
    {
        ...
        public const string IDX40013 = "IDX40013: Cloud instance validation could not be performed. The signing key has a cloud instance name: '{0}', but the configuration does not contain a cloud instance name.";
        public const string IDX40014 = "IDX40014: Cloud instance validation could not be performed. The signing key was not found in the configuration's JSON Web Key Set, or it does not contain a cloud instance name.";
    }
}
