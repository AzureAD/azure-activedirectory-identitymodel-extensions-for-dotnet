...
#pragma warning disable RS0016 // Add public types and members to the declared API
    ...
    /// </summary>
    public class MldsaWin : Mldsa
    {
        private bool _disposed;

        internal MldsaWin() : base()
        {
            Handle = IntPtr.Zero;
        }
        ...
        internal MldsaWin(string publicKey, string algorithm)
        {
        ...
        {
            // TODO: this should be taking an allocated buffer.
            if (data == null)
