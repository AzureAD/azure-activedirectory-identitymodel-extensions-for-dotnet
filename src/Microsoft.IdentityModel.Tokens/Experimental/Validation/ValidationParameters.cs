...
namespace Microsoft.IdentityModel.Tokens.Experimental
{
    ...
    public class ValidationParameters
    {
        ...
        private IList<SecurityKey>? _signatureKeys;
        ...
        protected ValidationParameters(ValidationParameters other)
        {
            ...
            _signatureKeys = other.SignatureKeys;
        ...
        /// </summary>
        public IList<SecurityKey> SignatureKeys
        {
            get
            {
                return _signatureKeys ??
                    Interlocked.CompareExchange(ref _signatureKeys, [], null) ??
                    _signatureKeys;
            }
        }
        ...
        /// </summary>
        [DefaultValue(false)]
        public bool TryAllSignatureKeys { get; set; }
