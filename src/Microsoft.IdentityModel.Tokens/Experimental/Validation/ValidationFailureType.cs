...
public abstract class ValidationFailureType
{
    ...
    /// <summary>
    /// CryptoProvider IsSupportedAlgorithm returned <see langword="false"/>.
    /// </summary>
    public static readonly ValidationFailureType CryptoProviderAlgorithmNotSupported = new CryptoProviderAlgorithmNotSupportedFailure("CryptoProviderAlgorithmNotSupported");
    private class CryptoProviderAlgorithmNotSupportedFailure : ValidationFailureType { internal CryptoProviderAlgorithmNotSupportedFailure(string name) : base(name) { } }
