...
{
    /// <summary>
    /// Experimental interface that provides synchronous result based token validation instead of throwing exceptions.
    /// </summary>
    public interface IResultBasedValidationSync
    {
        /// <summary>
