...
namespace Microsoft.IdentityModel.Tokens
{
    ...
    public partial class TokenValidationParameters
    {
        ...
        protected TokenValidationParameters(TokenValidationParameters other)
        {
            ...
            IssuerSigningKeys = other.IssuerSigningKeys != null ? new List<SecurityKey>(other.IssuerSigningKeys) : null;
            ...
            PropertyBag = other.PropertyBag != null ? new Dictionary<string, object>(other.PropertyBag) : null;
            ...
            TokenDecryptionKeys = other.TokenDecryptionKeys != null ? new List<SecurityKey>(other.TokenDecryptionKeys) : null;
            ...
            ValidAlgorithms = other.ValidAlgorithms != null ? new List<string>(other.ValidAlgorithms) : null;
            ValidAudience = other.ValidAudience;
            ValidAudiences = other.ValidAudiences != null ? new List<string>(other.ValidAudiences) : null;
            ValidIssuer = other.ValidIssuer;
            ValidIssuers = other.ValidIssuers != null ? new List<string>(other.ValidIssuers) : null;
            ValidTypes = other.ValidTypes != null ? new List<string>(other.ValidTypes) : null;
        }
