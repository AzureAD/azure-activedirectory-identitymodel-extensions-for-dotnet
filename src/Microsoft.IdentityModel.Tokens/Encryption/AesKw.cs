...
//        //protected static System.Security.Cryptography.RNGCryptoServiceProvider Rng = new RNGCryptoServiceProvider();
...
//#if NETSTANDARD1_4
//                _aes = new AesManaged { Mode = CipherMode.ECB, Padding = PaddingMode.None, KeySize = keyBytes.Length*8, Key = keyBytes };
//#else
