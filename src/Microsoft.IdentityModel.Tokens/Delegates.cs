...
namespace Microsoft.IdentityModel.Tokens
{
    ...
    /// <param name="tokenValidationParameters">Optional validation parameters if needed.</param>
    /// <returns>A ClaimsIdentity representing the actor.</returns>
    public delegate ClaimsIdentity ActClaimRetriever(JsonElement actClaim, TokenValidationParameters tokenValidationParameters);
}
