...
namespace Microsoft.IdentityModel.Tokens
{
    ...
    public class SecurityTokenInvalidAlgorithmException : SecurityTokenValidationException
    {
        ...
        internal SecurityTokenInvalidAlgorithmException(string message, ValidationError validationError)
        ...
        internal SecurityTokenInvalidAlgorithmException(string message, ValidationError validationError, Exception innerException)
