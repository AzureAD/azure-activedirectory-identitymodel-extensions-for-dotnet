...
namespace Microsoft.IdentityModel.Tokens
{
    ...
    public class SecurityTokenInvalidAudienceException : SecurityTokenValidationException
    {
        ...
        #region Experimental Members
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityTokenInvalidAudienceException"/> class.
        /// </summary>
        /// <param name="message">Additional information to be included in the exception and displayed to user.</param>
        /// <param name="validationError">The <see cref="ValidationError"/> that is associated with the exception.</param>
        internal SecurityTokenInvalidAudienceException(string message, ValidationError validationError)
        ...
        /// <param name="validationError">The <see cref="ValidationError"/> that is associated with the exception.</param>
        /// <param name="innerException">An <see cref="Exception"/> that represents the root cause of the exception.</param>
        internal SecurityTokenInvalidAudienceException(string message, ValidationError validationError, Exception innerException)
