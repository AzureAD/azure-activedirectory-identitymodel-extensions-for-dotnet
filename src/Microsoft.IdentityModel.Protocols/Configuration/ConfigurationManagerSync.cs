...
namespace Microsoft.IdentityModel.Protocols
{
    ...
    internal partial class ConfigurationManagerSync<T> : BaseConfigurationManagerSync, IConfigurationManagerSync<T> where T : class
    {
        ...
        // GetConfigurationWithBlockingSync so the original exception (e.g. an IOException carrying
        ...
        internal ConfigurationManagerSync(
        ...
        internal ConfigurationManagerSync(
            ...
            IConfigurationValidator<T> configValidator,
            LastKnownGoodConfigurationCacheOptions lkgCacheOptions,
            IConfigurationEventHandlerSync<T> configurationEventHandler)
            : this(metadataAddress, configRetriever, docRetriever, configValidator, lkgCacheOptions)
        {
            ...
            ConfigurationEventHandlerSync = configurationEventHandler;
        }
        ...
        /// then this method will not update the configuration, instead it will request the next call to <see cref="GetConfigurationSync()"/>
        ...
        /// <summary>
        /// 12 hours is the default time interval that afterwards, <see cref="GetBaseConfigurationSync(CancellationToken)"/> will obtain new configuration.
        /// </summary>
...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        /// Called by <c>GetConfigurationNonBlockingSync</c>.
        /// </summary>
        ...
        /// and <see cref="HandleBlockingRetrievalException"/>.
        /// </summary>
        ...
        /// Called by <c>HandleBeforeRetrieveSync</c>.
        /// </summary>
