...
namespace Microsoft.IdentityModel.Protocols
{
    ...
    {
        /// <summary>
        /// Retrieves a populated configuration given an address and an <see cref="ISyncDocumentRetriever"/>.
        /// </summary>
        ...
        T GetConfigurationSync(string address, ISyncDocumentRetriever retriever, CancellationToken cancel);
    }
}
